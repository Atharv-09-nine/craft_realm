    ...
    <div className="w-64 bg-background-secondary border-r border-background-tertiary h-screen flex flex-col">
      ...
      <div className="p-4 border-b border-background-tertiary">
        <div className="flex items-center space-x-3 mb-3">
          <div className="w-8 h-8 bg-gradient-to-br from-accent-gold to-accent-gold-dark rounded-full flex items-center justify-center">
      ...
      <div className="p-4 border-t border-background-tertiary">
        <div className="text-xs text-foreground-muted text-center">
          <div className="mb-2">CodeCrafts Adventures</div>
          <div>v1.0.0</div>
        </div>
      </div>
    </div>
